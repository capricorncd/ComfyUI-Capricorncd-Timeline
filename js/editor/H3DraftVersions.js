...
export const draftT = makeT({
    en: {
        ...
        hint: 'Run automatically refines the latest valid preview latent. Disabled versions remain available for preview. Removing a version only unlinks it; files stay on disk.',
        ...
        failed: 'Could not run: {message}', prompt: 'Preview sampling prompt', removed: 'Remove this version from the Clip? Its files will be kept.',
    },
    zh: {
        ...
        hint: '运行时自动使用最新有效预览的 latent 进行二次采样。禁用后仍可预览；删除仅移除 Clip 关联，磁盘文件保留。',
        enabled: '启用', disabled: '已禁用', remove: '删除版本', close: '关闭',
        no_video: '预览视频不可用。', unavailable: '请先将 H3 Video Generator 连接到当前时间轴编辑器。',
        failed: '运行失败：{message}', prompt: '预览采样提示词', removed: '从 Clip 移除此版本？视频和 latent 文件会保留。',
    },
    ja: {
        ...
        hint: '実行時は最新の有効なプレビュー latent から二次生成します。無効な候補も再生できます。削除は関連付けのみで、ファイルは残ります。',
        enabled: '有効', disabled: '無効', remove: '候補を削除', close: '閉じる',
        no_video: 'プレビュー動画がありません。', unavailable: 'H3 Video Generator をこのタイムラインに接続してください。',
        failed: '実行失敗：{message}', prompt: 'プレビューのプロンプト', removed: 'Clip から候補を削除しますか？ファイルは残ります。',
    },
});
