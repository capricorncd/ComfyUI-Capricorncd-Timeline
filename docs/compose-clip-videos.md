...
- `trim_extends`: remove overlap and generation padding, preserving H3 continuation tail frames. Total duration may exceed the timeline duration. Disable to keep complete files.
